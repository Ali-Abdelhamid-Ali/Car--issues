...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        # 'rest_framework.permissions.IsAuthenticated',  # Enable in production
        'rest_framework.permissions.AllowAny',  # For development/testing
    ],
...
TRAINED_MODEL_PATH = BASE_DIR / 'ml_models' / 'the_model_fixed.h5'
